                    ...
                    <div class="col-sm-12">
                        <section class="card">
                            <header class="card-header bg-info">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="mb-0 text-white" >All VAriation List</h4>
                                    </div>
                                    <div class="col-md-6 text-end">
                                        <a class="btn btn-primary" href="{{URL::to('admin/variations/create')}}">Create New </a>
                                    </div>
                                </div>
                            </header>
                        <div class="card-body">    
 ...
 @section('js')
       ...
       <script>
        $(function () {
            ...
            ajax: {
                url: "{{URL::to('admin/variations/index')}}",
                type: "GET",
                data: function ( d ) {
