...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Variation "{{$variation->title}}" 
            </h4>
        </div>
            ...
            <div class="col-sm-5">
                <section class="card">
                     <header class="card-header bg-info">
                         <h4 class="mb-0 text-white" >Add New Variation</h4>
                     </header>
                     <div class="card-body">  
                         <form method="post" action="{{URL::to('/admin/variations_items/store')}}">
                             @csrf
                  ...
                  <div class="col-sm-7">
                        <section class="card">
                            <header class="card-header bg-info">
                                <h4 class="mb-0 text-white">{{$variation->title}} 's All Variation</h4>
                            </header>
                            <div class="card-body">  
                                {{-- {{ $pageItems }} --}}
                                <ul class="menus-box" >
                                    @foreach ($pageItems as $value_item)

                                    @component('admin.variations.variation-items.item',[
                                        'data' => $value_item,
                                        'level' => 1,
                                    ])@endcomponent
